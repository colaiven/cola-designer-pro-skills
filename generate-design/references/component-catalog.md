...
- 深色科技风大屏：`bgColor` 用深蓝黑（如 `#0a1a2f` / `#0e1a2b` / `#0b1633`），文字/坐标轴用 `#dce6f2`/`#cccccc`，主题色用 `#409EFF`/`#31adfb`，点缀 `#00f0ff`/`#f6c603`。
- 浅色报告风：`bgColor` 用 `#f5f7fa`，文字用 `#333333`，主题色用 `#0061C2`，图例/坐标轴文字改深色。
- 同一大屏内主色统一 1–2 个 + 渐变辅助；KPI 卡片背景可用 `["#0061C2","#409EFF"]` 渐变。
